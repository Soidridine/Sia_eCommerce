...
class Product
{
    ...
    /**
     * Permet de recuperer le  product sous forme de string pour pouvoir l'utiliser dans le formulaire de categorie quant on saisie une au lieu de récuprer un objet produit
     *
     * @return string
     */
